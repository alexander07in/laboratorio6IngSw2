...
public class ClienteMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Ejemplo de un paquete a Oriente Medio, que visitara tres paises: Egipto, Turquia, Iran
        PaqueteComponent principal2 = new RegionComponent("Asia");
        PaqueteComponent pais5 = new RegionComponent("Egipto");
        PaqueteComponent pais6 = new RegionComponent("Turquia");
        PaqueteComponent pais7 = new RegionComponent("Iran");

        PaqueteComponent ciudad5 = new CiudadComponent("El Cairo", 2000000);
        PaqueteComponent ciudad6 = new CiudadComponent("Alejandria", 3000000);
        PaqueteComponent ciudad7 = new CiudadComponent("Ankara", 4000000);
        PaqueteComponent ciudad8 = new CiudadComponent("Teherán", 5000000);

        principal2.addComponent(pais5);
        principal2.addComponent(pais6);
        principal2.addComponent(pais7);

        pais5.addComponent(ciudad5);
        pais5.addComponent(ciudad6);
        pais6.addComponent(ciudad7);
        pais7.addComponent(ciudad8);
        ...
        System.out.println(" Pais 7 = "
                + pais7.getNombre() + " " + pais7.getComponentPrecio() + " Pesos");
